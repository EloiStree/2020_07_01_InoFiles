...
SensorState  m_sensors[]= {
   ...
   SensorState(true,20,800,800, CapacitiveSensor(13,12)),
   //SensorState(true,20,200,800, CapacitiveSensor(10,A0)),
   SensorState(true,20,800,800, CapacitiveSensor(A1,9)),
   SensorState(true,20,800,800, CapacitiveSensor(8,A2)),
   SensorState(true,20,800,800, CapacitiveSensor(A3,7)),
   SensorState(true,20,800,800, CapacitiveSensor(6,A4)),
   SensorState(true,20,800,800, CapacitiveSensor(A5,5)),
   SensorState(true,20,800,800, CapacitiveSensor(3,2)),
  } ;
float m_capacitiveValue=60;
