...
class SensorState{
  ...
  CapacitiveSensor m_sensor= CapacitiveSensor(4,5);
    SensorState(bool listenToIt, float capacitive,float resistance, float contact,  CapacitiveSensor sensor){
...
SensorState  m_sensors[]= {
   SensorState(true,40,10000,120000, CapacitiveSensor(2,6)),
   SensorState(true,40,10000,120000, CapacitiveSensor(2,9)),
   SensorState(false,40,60000,120000, CapacitiveSensor(2,3)),
   SensorState(false,40,60000,120000, CapacitiveSensor(2,4)),
   SensorState(true,40,10000,120000, CapacitiveSensor(2,5)),
   SensorState(true,40,10000,120000, CapacitiveSensor(2,7)),
   SensorState(true,40,10000,120000, CapacitiveSensor(2,8))
  } ;
 float m_capacitiveValue=60;

const int analogCount=5;
int analog[]= {A1,A2,A3,A4,A5};
